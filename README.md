...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create best-game-ever-5607
  fly apps create best-game-ever-5607-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app best-game-ever-5607
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app best-game-ever-5607-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly volumes create data --size 1 --app best-game-ever-5607
  fly volumes create data --size 1 --app best-game-ever-5607-staging
  ```
